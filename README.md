...
```javascript
ssort2sh = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ssort2sh@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-ssort2sh/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/blas-ext-base-ssort2sh/actions/workflows/test.yml?query=branch:v0.2.3
