...
```javascript
ssort2sh = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ssort2sh@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ssort2sh@umd/bundle.js"></script>
```
